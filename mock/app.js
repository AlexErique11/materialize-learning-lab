...
const els = {
  ...
  chapter4Hub: document.querySelector("#chapter4Hub"),
  chapter4Visualization: document.querySelector("#chapter4Visualization"),
  ...
  chapter7Hub: document.querySelector("#chapter7Hub"),
  chapter7Visualization: document.querySelector("#chapter7Visualization"),
  chapter7Frame: document.querySelector("#chapter7Frame"),
  chapter7VisualizationTitle: document.querySelector("#chapter7VisualizationTitle"),
  chapter7Back: document.querySelector("#chapter7Back"),
  chapter8Hub: document.querySelector("#chapter8Hub"),
  chapter8Visualization: document.querySelector("#chapter8Visualization"),
  ...
  chapter11Hub: document.querySelector("#chapter11Hub"),
  chapter11Visualization: document.querySelector("#chapter11Visualization"),
  chapter11Frame: document.querySelector("#chapter11Frame"),
  chapter11VisualizationTitle: document.querySelector("#chapter11VisualizationTitle"),
  chapter11Back: document.querySelector("#chapter11Back"),
  chapter12Hub: document.querySelector("#chapter12Hub"),
  chapter12Visualization: document.querySelector("#chapter12Visualization"),
...
els.chapter4Hub.addEventListener("click", (event) => {
...
els.chapter7Hub.addEventListener("click", (event) => {
  openChapterVisualization(event, els.chapter7Hub, els.chapter7Visualization, els.chapter7Frame, els.chapter7VisualizationTitle);
});
els.chapter7Back.addEventListener("click", showChapter7Hub);
els.chapter8Hub.addEventListener("click", (event) => {
...
els.chapter11Hub.addEventListener("click", (event) => {
  openChapterVisualization(event, els.chapter11Hub, els.chapter11Visualization, els.chapter11Frame, els.chapter11VisualizationTitle);
});
els.chapter11Back.addEventListener("click", showChapter11Hub);
els.chapter12Hub.addEventListener("click", (event) => {
...
els.labList.addEventListener("click", (event) => {
  ...
  if (button.dataset.chapterHub === "07") {
    showChapter7Hub();
    return;
  }
  ...
  if (button.dataset.chapterHub === "11") {
    showChapter11Hub();
    return;
  }
...
function showChapter7Hub() {
  hideCheckpoint();
  hideChapterPages();
  els.coreWorkspace.hidden = true;
  els.chapter7Hub.hidden = false;
}

function showChapter8Hub() {
  hideCheckpoint();
  hideChapterPages();
  els.coreWorkspace.hidden = true;
...
function showChapter11Hub() {
  hideCheckpoint();
  hideChapterPages();
  els.coreWorkspace.hidden = true;
  els.chapter11Hub.hidden = false;
}

function showChapter12Hub() {
  hideCheckpoint();
  hideChapterPages();
  els.coreWorkspace.hidden = true;
